...
- [📦 Swiftfin as a Library](https://github.com/jellyfin/Swiftfin/blob/main/Documentation/swiftpm.md) — Embed Swiftfin in another app with **SwiftPM**, from source or as a prebuilt **XCFramework**.
